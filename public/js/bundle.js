...
var showAlert = function showAlert(type, message, elementClass) {
  hideAlerts();
...
// login form
var login = function login(_ref, endPoint) {
  var email = _ref.email,
      password = _ref.password;
  (0, _axios.default)({
    method: 'POST',
    url: "".concat(window.location.origin).concat(endPoint),
    data: {
      email: email,
      password: password
    }
    ...
    if (res.data.status === 'success') {
      (0, _alerts.showAlert)('success', 'You have logged in', 'body');
      window.setTimeout(function () {
        window.location.assign('/');
      }, 500);
    }
  }).catch(function (err) {
    (0, _alerts.showAlert)('error', err.response.data.message, 'body');
  });
};
...
var logout = function logout() {
  (0, _axios.default)({
    method: 'GET',
    url: "".concat(window.location.origin, "/api/v1/users/logout")
  }).then(function (res) {
    (0, _alerts.showAlert)('success', 'You have logged out successfully', 'body');
    window.setTimeout(function () {
      window.location.assign('/');
    }, 500);
  }).catch(function (e) {
    (0, _alerts.showAlert)('error', e.response.data.message, 'body');
  });
};
...
var _default = function _default(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib3Vkd2luIiwiYSI6ImNramI0YzFhdjBoNDIzMXNjb3NteDNsdHgifQ.uFmiV_GAQRTPcOejwzOgAg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add Popup to
...
},{}],"genericFormHandler.js":[function(require,module,exports) {
"use strict";
...
var arrToObject = function arrToObject(keys, fields) {
  var res = {};
  keys.forEach(function (key, idx) {
    res[(0, _camelcase.default)(key)] = fields[idx][key];
  });
  return res;
};
...
var _default = function _default() {
  ...
  var endPoint = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/api/v1/users/updateme';
  var fields = elements.map(function (el) {
    return _defineProperty({}, el, document.getElementById(el).value);
  });
...
exports.default = _default;
},{"camelcase":"../../node_modules/camelcase/index.js"}],"updateUser.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(data, endPoint) {
  return (0, _axios.default)({
    ...
    if (res.data.status === 'success') {
      (0, _alerts.showAlert)('success', 'Your account information has been updated successfully', 'body');
      window.setTimeout(function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51I5R1uL3C1EaPYFCjD7vp5PQLu750rMqUctEl8AJVLAgrUZfRx7fhnCOVoaDEIkvoIHAWYfjfIlXauKfC9XysAe000yKnf6veL');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("".concat(window.location.origin, "/api/v1/bookings/checkout-session/").concat(tourId));

          case 4:
            session = _context.sent.data.session;
            console.log(session); // 2) use stripe object to create checkout form + charge credit card for us
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', 'There was an error processing your order. Please contact support');
...
var _genericFormHandler = _interopRequireDefault(require("./genericFormHandler"));
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _genericFormHandler.default)(['email', 'password'], _auth.login, '/api/v1/users/login');
  });
} // logout
...
if (formUserData) {
  formUserData.addEventListener('submit', function (e) {
    ...
    (0, _updateUser.default)(form, '/api/v1/users/updateme');
  });
} // updatePassword
...
if (formUserPassword) {
  formUserPassword.addEventListener('submit', function (e) {
    e.preventDefault();
    var loadingBtn = document.getElementById('save-pw-btn');
    loadingBtn.textContent = 'Saving...';
    (0, _genericFormHandler.default)(['password', 'new_password', 'password-confirm'], _updateUser.default, '/api/v1/users/updateMyPassword').then(function (res) {
